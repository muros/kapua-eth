 ...
 */
public class KapuaLocatorConfiguration
{
    private static final Logger    s_logger                = LoggerFactory.getLogger(KapuaLocatorConfiguration.class);
    ...
    static {
        ...
        try {
            URL serviceConfigUrl = ResourceUtils.getResource(LOCATOR_CONFIG_RESOURCE);
    ...
    private KapuaLocatorConfiguration()
    {
    }
