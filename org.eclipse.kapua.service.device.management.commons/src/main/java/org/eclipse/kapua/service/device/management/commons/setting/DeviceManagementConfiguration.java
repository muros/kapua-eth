...
{
    private static final Logger    s_logger                          = LoggerFactory.getLogger(DeviceManagementConfiguration.class);

    private static final String    DEVICE_MANAGEMENT_CONFIG_RESOURCE = "device-management-config.properties";
    ...
    static {
        ...
        try {
            URL serviceConfigUrl = ResourceUtils.getResource(DEVICE_MANAGEMENT_CONFIG_RESOURCE);
