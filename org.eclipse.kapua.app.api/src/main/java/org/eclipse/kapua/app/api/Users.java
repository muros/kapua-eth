...
/*
import com.eurotech.cloud.apis.v2.resources.model.UsersResult;
import com.eurotech.cloud.commons.model.User;
import com.eurotech.cloud.commons.model.UserCreator;
import com.eurotech.cloud.commons.service.ServiceLocator;
import com.eurotech.cloud.commons.service.UserService;
*/

@Path("/users")
public class Users extends KapuaResource 
{
	/**
...
//
//			List<User> users = us.findWithAccessInfoAll(targetAccountId);
