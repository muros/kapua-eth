 ...
 */
public class KapuaUserConfiguration
{
	private static final Logger s_logger = LoggerFactory.getLogger(KapuaUserConfiguration.class);
	
	private static final String USER_CONFIG_RESOURCE = "kapua-user-config.properties";
    ...
    private KapuaUserConfiguration() {}
