...
public class EdcErrorHandlerServlet extends EdcHttpServlet
{
    private static final long serialVersionUID       = 823090686760110256L;

    private static Logger     s_logger               = LoggerFactory.getLogger(EdcErrorHandlerServlet.class);
