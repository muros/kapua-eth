...
public class GwtEdcPublish implements Serializable {
    ...
    public GwtEdcPublish() {
        this.numberValues = new HashMap<String,Number>();
        this.stringValues = new HashMap<String,String>();
    }

    public GwtEdcPublish(GwtMqttTopic topic, Date timestamp, byte[] payload) {
    ...
    public GwtEdcPublish(GwtMqttTopic topic, Date timestamp, Map<String,Number> numberValues, Map<String, String> stringValues) {
        this.gwtMqttTopic     = topic;
        this.timestamp = timestamp;
    ...
    public String toString() {
        return "GwtEdcPublish [topic=" + gwtMqttTopic + "]";
    }
}
