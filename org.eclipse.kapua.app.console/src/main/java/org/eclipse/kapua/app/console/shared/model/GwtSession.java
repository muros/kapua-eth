...
public class GwtSession extends EdcBaseModel implements Serializable
{
    ...
    private String            m_googleAnalyticsTrackingId;
    ...
    {
        return m_googleAnalyticsTrackingId;
    }

    public void setGoogleAnalyticsTrackingId(String googleAnalyticsTrackingId)
    {
        m_googleAnalyticsTrackingId = googleAnalyticsTrackingId;
    }
