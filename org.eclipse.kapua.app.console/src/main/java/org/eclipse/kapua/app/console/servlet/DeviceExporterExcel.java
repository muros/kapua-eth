    ...
    throws ServletException, IOException {
        ...
        for (DeviceOld device : devices) {
            ...
            if (device.getConnectionStatus() != null) {
                row.createCell(iColCount++).setCellValue(truncate(device.getConnectionStatus().name()));
            } else {
                row.createCell(iColCount++).setCellValue("");
            }
            ...
            if (device.getConnectionIp() != null) {
                row.createCell(iColCount++).setCellValue(device.getConnectionIp());
            } else {
                row.createCell(iColCount++).setCellValue("");
            }
            ...
            if (device.getOsgiFrameworkVersion() != null) {
                row.createCell(iColCount++).setCellValue(truncate(device.getOsgiFrameworkVersion()));
            } else {
                row.createCell(iColCount++).setCellValue("");
            }

            if (device.getEsfKuraVersion() != null) {
                row.createCell(iColCount++).setCellValue(truncate(device.getEsfKuraVersion()));
            } else {
                row.createCell(iColCount++).setCellValue("");
            }
            ...
            if (device.getSignedCertificateId() != null) {
                row.createCell(iColCount++).setCellValue(truncate(""+device.getSignedCertificateId()));
            } else {
                row.createCell(iColCount++).setCellValue("");
            }
