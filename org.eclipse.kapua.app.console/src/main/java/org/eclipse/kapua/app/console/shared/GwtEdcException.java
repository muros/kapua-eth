...
/**
 * The GwtEdcException class is the superclass of all GWT errors and exceptions in the Everyware Cloud project. It extends the JDK Exception class by requesting its invokers to provide an error code when
