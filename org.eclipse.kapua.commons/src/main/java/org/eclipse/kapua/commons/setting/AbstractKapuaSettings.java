...
public abstract class AbstractKapuaSettings<K extends SettingKey>
{
    private static final Logger s_logger = LoggerFactory.getLogger(AbstractKapuaSettings.class);

    protected DataConfiguration config;

    protected AbstractKapuaSettings(String configResourceName)
    {
