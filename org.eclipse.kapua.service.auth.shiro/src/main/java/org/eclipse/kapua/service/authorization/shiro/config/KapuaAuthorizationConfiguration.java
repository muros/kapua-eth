 ...
 */
public class KapuaAuthorizationConfiguration
{
    private static final Logger    s_logger                      = LoggerFactory.getLogger(KapuaAuthorizationConfiguration.class);

    private static final String    AUTHORIZATION_CONFIG_RESOURCE = "kapua-authorization-config.properties";
    ...
    static {
        ...
        try {
            URL serviceConfigUrl = ResourceUtils.getResource(AUTHORIZATION_CONFIG_RESOURCE);
    ...
    private KapuaAuthorizationConfiguration()
    {
    }
