...
public class EsAssetTopicDAO
{
    ...
    public EsAssetTopicDAO setListener(EsDaoListener daoListener)
    ...
    public EsAssetTopicDAO unsetListener(EsDaoListener daoListener)
        throws EsDatastoreException
    {
    ...
    public static EsAssetTopicDAO connection(Client client)
    ...
    public void deleteByTopic(String accountName, String asset, boolean isAnyAsset, String semTopic, boolean isAnySubtopic)
