...
public class EsTopicMetricDAO {
	...
	public EsTopicMetricDAO setListener(EsDaoListener daoListener) throws EsDatastoreException {
		this.esTypeDAO.setListener(daoListener);
		return this;
	}
	
	public EsTopicMetricDAO unsetListener(EsDaoListener daoListener) throws EsDatastoreException {
		this.esTypeDAO.unsetListener(daoListener);
		return this;
	}
	
	public static EsTopicMetricDAO connection(Client client) throws UnknownHostException {
