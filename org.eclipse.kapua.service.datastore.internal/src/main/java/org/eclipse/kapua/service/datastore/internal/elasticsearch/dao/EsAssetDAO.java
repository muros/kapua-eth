...
public class EsAssetDAO {
	...
	public EsAssetDAO setListener(EsDaoListener daoListener) throws EsDatastoreException {
		this.esTypeDAO.setListener(daoListener);
		return this;
	}
	
	public EsAssetDAO unsetListener(EsDaoListener daoListener) throws EsDatastoreException {
		this.esTypeDAO.unsetListener(daoListener);
		return this;
	}
	
	public static EsAssetDAO connection(Client client) throws UnknownHostException {
