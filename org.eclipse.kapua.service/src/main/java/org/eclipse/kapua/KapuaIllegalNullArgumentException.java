 ...
 * or as a value for field in an object where <tt>null</tt> is not allowed. This should always be
 * used instead of <tt>NullPointerException</tt> as the latter is too easily confused with programming bugs.
 */
