    ...
    public KapuaExecutorThreadFactory(String name, List<String> threadPoolNameMatcher, boolean rootThreadGroup)
    {
        ...
        if (rootThreadGroup) {
            while (currentTg.getParent() != null) {
                ...
                // The JVM-created system group organizes JVM threads that deal with object finalization and other system tasks, and serves as the root thread group of an application's hierarchical
