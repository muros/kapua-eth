...
public class JmsAssistantProducerWrapper extends JmsProducerWrapper
{
    ...
    // ==========================================================
    // Messages to be send outside (to a specific topic) NO LONGER USED!
    // ==========================================================

    // public void sendConnectMessage(ConnectorDescriptor connectorDescriptor, String accountName, long accountId, String userName, Long userId, String clientId, String nodeId, String remoteAddress)
    ...
    // private KapuaMessage<KapuaChannel, KapuaPayload> buildNetworkKapuaMessage(List<String> semanticTopic, String accountName, String userName, Long userId, String clientId, String nodeId, String
    // remoteAddress) {
