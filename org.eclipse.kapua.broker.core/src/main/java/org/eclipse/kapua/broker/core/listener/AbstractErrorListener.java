 ...
 */
public abstract class AbstractErrorListener<M extends Object> {
	...
	protected AbstractErrorListener(String name) {
		this.name = name;
	}
	
	public abstract void processMessage(Exchange exchange, M message) throws KapuaException;
